...
echo "   ${BLUE}open -a Kaset${NC}"
echo ""
echo "2. Grant accessibility permissions for closing duplicate windows:"
echo "   ${BLUE}System Preferences > Privacy & Security > Accessibility${NC}"
echo "   Add your terminal app (Terminal, iTerm, Warp, etc.)"
echo ""
echo "3. Try it out!"
echo "   ${BLUE}openclaw 'play some led zeppelin'${NC}"
echo ""
