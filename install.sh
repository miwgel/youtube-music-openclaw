...
printf "2. (Optional) Grant accessibility permissions to auto-close duplicate windows:\n"
printf "   ${BLUE}System Settings > Privacy & Security > Accessibility${NC}\n"
printf "   Add whatever app launches OpenClaw (Terminal, iTerm, Warp, VS Code, etc.)\n\n"
printf "3. Try it out!\n"
